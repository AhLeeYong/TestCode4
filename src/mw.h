...
#define  VERSION  211
#define  FIRMWARE  "HarakiriSG pre2.6 TestCode4" __DATE__ " / " __TIME__
...
extern uint16_t GPS_Conf600[2];             // GPS confidence 600cm in RAW tics to judge if better use spikefiltervalues
